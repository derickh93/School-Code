...
public class PokerHand {
	...
	public boolean flush() {
		if (card1.getSuit().equals(card2.getSuit()) && card1.getSuit().equals(card3.getSuit())
				&& card1.getSuit().equals(card4.getSuit()))
			return true;
		else
			return false;
	}
	...
	public boolean threeOfAKind() {
		if (card1.getValue() == card2.getValue() && card1.getValue() == card3.getValue() || 
				card1.getValue() == card2.getValue() && card1.getValue() == card4.getValue() ||
				card1.getValue() == card3.getValue() && card1.getValue() == card4.getValue() ||
				card2.getValue() == card3.getValue() && card2.getValue() == card4.getValue())
			return true;
		else 
			return false;
	}
	...
	public boolean pair() {
		if (card1.getValue() == card2.getValue() || card1.getValue() == 
				card3.getValue() || card1.getValue() == card4.getValue()) {
			return true;
		}
		if (card2.getValue() == card3.getValue() || card2.getValue() == 
				card4.getValue() || card2.getValue() == card1.getValue()) {
			return true;
		}
		if (card3.getValue() == card4.getValue() || card3.getValue() == card1.getValue() ||
	...
	public Card lowCard() {
		if 	((card1.getValue() <= card2.getValue()) && (card1.getValue() <= card3.getValue())
			...
			return card2;
		else if ((card3.getValue() <= card1.getValue()) && (card3.getValue() <= card2.getValue()) 
				&& (card3.getValue() <= card4.getValue()))
			return card3;
		else if ((card4.getValue() <= card1.getValue()) && (card4.getValue() <= card2.getValue()) 
				&& (card4.getValue() <= card3.getValue()))
			return card4;
		else 
			return null;		
	 ...
	 * @param chosenCard the number of the card to be replaced
	 * @param otherCard the card to be placed into the poker hand
	 */
	public void replaceCard(int chosenCard, Card otherCard) {
		if (chosenCard == 1)
			card1 = otherCard;
