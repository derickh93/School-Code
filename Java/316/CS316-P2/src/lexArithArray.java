...
This class is a lexical analyzer for the 26 token categories <int> through <comma> defined by:
...
There are also special states for the keywords "int", "float", "boolean", "if", "else", "while", "do", "false", "true".
...
public abstract class lexArithArray
{
	...
	private static String int_     = "int";
	private static String float_   = "float";
	...
	private static void keywordCheck()
	{
		...
		else if ( t.equals(float_) )
			state = State.Keyword_float;
		else if ( t.equals(boolean_) )
