...
final class ClassObj extends Val
{
	...
	HashMap<String,LinkedList<String>> functions; // function names mapped to its value


	ClassObj(String cn, HashMap<String, Val> fs,HashMap<String,LinkedList<String>> fm)
	{
		className = cn;
		fields = fs;
		functions = fm;
	...
	{
		return className + " object: " + fields.toString() +  "functions: " + functions.toString();
	}
