...
This class is a lexical analyzer for the 23 token categories <int>
...
There are also three special states for the keywords "if", "else", "while".
...
public abstract class LexAnalyzer
{
	...
	protected static boolean isFinal(State state)
	{
