...
public class Lab6App {
	...
	public static void orderPacket() throws FileNotFoundException  {
		ArrayList<Packet> packetOne = new OrderedArrayList<Packet>();
	...
	public static void main (String[] args) throws FileNotFoundException {
		...
		ArrayList<Product> list1 = new OrderedArrayList<Product>();
		ArrayList<Product> list2 = new OrderedArrayList<Product>(5);
