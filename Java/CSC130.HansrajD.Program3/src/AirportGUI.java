...
public class AirportGUI extends JFrame implements ActionListener{
	private static long simStartTime = SimulationTime.timeInMinutes(Calendar.getInstance().getTimeInMillis());
	...
	public void setStartTime(){
		simStartTime = SimulationTime.timeInMinutes(Calendar.getInstance().getTimeInMillis());
	}
	public synchronized long elaspedTime(){
		return SimulationTime.timeInMinutes(Calendar.getInstance().getTimeInMillis())  
			- simStartTime;
	}
}