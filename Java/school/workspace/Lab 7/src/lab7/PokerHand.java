...
public class PokerHand
{
	...
	public boolean flush() {
		if ((card1.getSuit().equals(card2.getSuit())) && 
			(card1.getSuit().equals(card3.getSuit())) && 
	...
	public boolean threeofAKind() {
		if 	((card1.equalValue(card2) && card1.equalValue(card3)) ||
			(card1.equalValue(card3) && card1.equalValue(card4)) ||
			(card2.equalValue(card3) && card2.equalValue(card4)) ||
			(card1.equalValue(card2) && card1.equalValue(card3)) ||
			(card1.equalValue(card2) && card1.equalValue(card4)))
			return true;
		else
			return false;
	}
	...
	public Card lowCard() {
		if 	((card1.getValue() <= card2.getValue()) && 
			...
			return card3;
		else if ((card4.getValue() <= card1.getValue()) && 
				(card4.getValue() <= card2.getValue()) &&
