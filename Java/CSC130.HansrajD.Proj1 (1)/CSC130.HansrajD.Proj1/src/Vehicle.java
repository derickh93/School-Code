...
public abstract class Vehicle {
	 ...
	 */
	public Vehicle(String customerId, String manufacturer, String model) {
	...
	public void rentVehicle(String transaction, String vehicle, String id) {
		if(transaction.equalsIgnoreCase("rent")) {
			setAvailable(false);
		}
	}
	 ...
	 */
	public abstract double returnVehicle(String transaction, String id, int num, int num2);
	...
	public String toString() {
		return "manufacturer=" + manufacturer + ", " + "model=" + model + ", "  + "available=" + available + ", "  + "renter=" +  customerId;
	}
}
