...
public class Card {
	...
	/**
	 * default constructor -- gets called when an object of the Card class
	...
	/**
	 * parameterized constructor -- gets called when an object of the Card class is
	...
	/**
	 * toString -- this method returns the state of the Card object
	 * 
	...
	/**
	 * setRank -- modifies the value of the instance variable rank
	 * 
	 * @param r
	 *            a number between 0 and and 12 representing the rank
	 */
	...
	/**
	 * setSuit -- modifies the value of the instance variable suit
	 * 
	 * @param s
	 *            a number between 0 and and 3 representing the suit
	 */
	...
	/**
	 * getRank -- returns what's stored in the instance variable rank
	 * 
	...
	/**
	 * getSuit -- returns what's stored in the instance variable suit
	 * 
	...
	/**
	 * getRankAsString -- returns a String representation of the instance
	 * variable rank
	 * 
	...
	/**
	 * getSuitAsString -- returns a String representation of the instance
	 * variable suit
	 * 
