...
public class Stack<T> implements StackADT<T> {
	...
	/**
	 * default constructor -- Constructs a new Stack with capacity for 100 objects
	 */
	public Stack(){
	...
	/**
	 * parameterized constructor -- Constructs a new Stack with capacity specified by user
	...
	/**
	 * toString -- Returns the current state of this stack. 
