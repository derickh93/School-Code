...
public class Lab7App
{
	...
	public static void testFlush()
	{
		...
		System.out.println("Replaced the 2 of hearts with the 4 of clubs and the "
		    + "2 of spades with the 5 of clubs: \n" + hand3.toString());
		if (hand3.flush())
			System.out.println("Flush");
		else 
			System.out.println("Not a flush");
	...
	public static void testThreeOfAKind()
	{
		...
		System.out.println("");
		hand5.replaceCard(1, threeClubs);
	...
	public static void testLowCard()
	{
		...
		System.out.println("");
		hand9.replaceCard(1, threeClubs);
		hand9.replaceCard(2, twoClubs);
		hand9.replaceCard(3, fourClubs);
		hand9.replaceCard(4, fiveClubs);
		...
		System.out.println("");
		hand9.replaceCard(1, threeClubs);
		hand9.replaceCard(2, fourClubs);
		hand9.replaceCard(3, twoClubs);
		hand9.replaceCard(4, fiveClubs);
		System.out.println(hand9.toString());
		System.out.println("The low card is " + hand9.lowCard());
		System.out.println("");
		hand9.replaceCard(1, threeClubs);
		hand9.replaceCard(2, fourClubs);
		hand9.replaceCard(3, fiveClubs);
		hand9.replaceCard(4, twoClubs);
		System.out.println(hand9.toString());
		System.out.println("The low card is " + hand9.lowCard());
		System.out.println("");
		hand9.replaceCard(1, threeClubs);
		hand9.replaceCard(2, twoDiamonds);
		hand9.replaceCard(3, fiveClubs);
		hand9.replaceCard(4, twoClubs);
		System.out.println(hand9.toString());
		System.out.println("The low card is " + hand9.lowCard());
