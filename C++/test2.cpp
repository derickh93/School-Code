...
class Student
{
	...
	public:
		...
		void input();
		void output();
        const Student operator+(const Student&) const;
};
...
const Student Student::operator+(const Student& other) const {
    std::cout << firstName << other.firstName << std::endl;
    std::cout << lastName << other.lastName << std::endl;
    std::cout << dateOfBirth << other.dateOfBirth << std::endl;
    std::cout << dateOfMat << other.dateOfMat << std::endl;
    std::cout << gpa << other.gpa << std::endl;
    std::cout << credits << other.credits << std::endl;
}
